...
client.adminCommands.set('play', require('./commands/playtest.js'));
client.adminCommands.set('skip', require('./commands/playtest.js'));
client.adminCommands.set('stop', require('./commands/playtest.js'));
client.adminCommands.set('list', require('./commands/playtest.js'));

client.on('message', async message => require('./events/message.js')(client, message));
